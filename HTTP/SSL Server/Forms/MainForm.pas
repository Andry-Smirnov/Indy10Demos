...
type
  TfrmMain = class(TForm)
    ...
    edCipherList: TEdit;
    edKeyFile: TEdit;
    edRootCertFile: TEdit;
    edPassword: TEdit;
    cbMaskPass: TCheckBox;
...
// for you by default.
  ...
  Ini.WriteString('SSLSettings', 'CertFile', edCertFile.Text);
  Ini.WriteString('SSLSettings', 'CipherList', edCipherList.Text);
  Ini.WriteString('SSLSettings', 'KeyFile', edKeyFile.Text);
  Ini.WriteString('SSLSettings', 'RootCertFile', edRootCertFile.Text);
  Ini.WriteString('SSLSettings', 'Password', edPassword.Text);
end;
...
procedure TfrmMain.OpenSSLGetPassword(
  var Password: String);
begin
  Password := edPassword.Text;
end;

procedure TfrmMain.cbMaskPassClick(Sender: TObject);
begin
  if cbMaskPass.Checked then
